...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-12-2020 a las 04:02:55
...
(35, 'Actividad', 'Voluntariado', 'Limpieza urbana', 'Limpieza de calles', 'Grupal', 'Limpieza de amador', 'En revision', 'google.com', '2020-12-03', 'Remover la basura de las calles y aceras', 'Trabajar en equipo', 'Franklin Quintero'),
(36, 'Actividad', 'Voluntariado', 'Limpieza urbana', 'Limpieza de calles', 'Grupal', 'Limpieza de amador', 'En revision', 'google.com', '2020-12-03', 'Remover la basura de las calles y aceras', 'Trabajar en equpipo', 'Franklin Quintero');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `proyectosparticipantes`
--
...
--
-- Volcado de datos para la tabla `proyectosparticipantes`
--
...
--
-- Indices de la tabla `proyectosparticipantes`
--
...
--
-- Filtros para la tabla `proyectosparticipantes`
--
ALTER TABLE `proyectosparticipantes`
